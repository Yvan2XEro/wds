      ...
      >
        <nav>
          <ul className="items-center justify-between pt-4 text-base text-[white] lg:flex lg:pt-0">
            ...
            <li>
              <a
                className="block px-0 py-3 mb-2 border-b-2 border-transparent lg:p-4 hover:border-[indigo-400] lg:mb-0"
                href="#"
              >
                Support
              </a>
        ...
        >
          <img
            className="w-10 h-10 border-2 border-transparent rounded-full hover:border-[indigo-400]"
